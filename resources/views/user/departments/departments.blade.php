                ...
                <div class="col-xl-8">
                    <div class="blog-4__item mb-80">
                        ...
                        <div class="blog-4__item-content">
                            ...
                            <h2 class="title-animation mb-10"><a href="blog-details.html">Health Harmony Symphony Wellbeing</a></h2>
                            ...
                            <a href="blog-details.html" class="rr-btn rr-btn__transparent">
                                <span class="btn-wrap">
                    ...
                    <div class="blog-4__item mb-80">
                        <a href="#" class="blog-4__item-thumb mb-10">
                            <img src="./assets/imgs/blog-4/blog-4__item-2.jpg" class="img-fluid" alt="image not found">
                        </a>
                    ...
                    <div class="blog-4__item mb-80">
                        <a href="#" class="blog-4__item-thumb mb-10">
                            <img src="./assets/imgs/blog-4/blog-4__item-3.jpg" class="img-fluid" alt="image not found">
                        </a>
                        ...
                        <div class="blog-4__item-content">
                            ...
                            <h2 class="title-animation mb-10"><a href="blog-details.html">Nurture Nature Blossoming in Health </a></h2>
                            <p class="mb-40">Web designing in a powerful way of just not an only professions, however, in a passion for our Company. We have to a tendency to believe the idea that smart looking of any websitet in on visitors.Web designing in a powerful way of just not an only profession Web designing in a powerful way of just not an Web designing </p>
                    ...
                    <ul class="blog-4__pagination d-flex flex-wrap align-items-center justify-content-center">
                        ...
                        <li><a href="#">2</a></li>
                        <li><a href="#">3</a></li>
                        <li><a href="blog-details.html"><i class="fa-solid fa-angle-right"></i></a></li>
                    </ul>
                </div>
                    ...
                    <div class="sidebar sidebar-rr-sticky">
                        ...
                        <div class="sidebar__widget">
                            ...
                            <div class="sidebar__widget-category">
                                <a href="blog-details.html">Health First</a>
                                <a href="blog-details.html">Medi Care</a>
                                <a href="blog-details.html">Care Well</a>
                                <a href="blog-details.html">Health Guard</a>
                                <a href="blog-details.html">Medi Connect</a>
                                <a href="blog-details.html">Medix Pro</a>
                            </div>
                        </div>
                    </div>
                </div>
